...
from PySide6.QtWidgets import (
    ...
    QMessageBox, QFileDialog, QHBoxLayout, QPushButton, QSizePolicy
)
from PySide6.QtCore import Qt, Signal, QRect
from ui.knowledge_ui import Ui_dataloader
from src.core.database_manager import DatabaseManager
import os
import logging
from config.config import PROJECT_ROOT
from src.gui.show_page.show_page import ShowPage
...
class KnowledgePage(QWidget):
    ...
    def setup_keywords_area(self):
        ...
        # 将keywords_widget添加到keywordsContainer中
        self.ui.keywordsContainer.layout().addWidget(self.keywords_widget)
    ...
    def setup_table(self):
        ...
        # 设置列宽
        self.ui.tableWidget.setColumnWidth(0, 250)  # 标题列宽
        self.ui.tableWidget.setColumnWidth(1, 100)  # 分类列宽
        self.ui.tableWidget.setColumnWidth(2, 700)  # 描述列宽
    ...
    def import_database(self):
        ...
        try:
            # 设置默认数据库文件夹路径
            default_db_path = os.path.join(PROJECT_ROOT, 'resources', 'db')
